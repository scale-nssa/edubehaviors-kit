...
If you find a security vulnerability in EduBehaviors-Kit, please report it through [GitHub's private vulnerability reporting](https://github.com/xanderbeberman/edubehaviors/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact beberman@stanford.edu for details.
